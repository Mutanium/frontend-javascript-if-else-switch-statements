...
for (let errorCode = 0; errorCode<5; errorCode++) {
...
// const mnitorColor = "green" geeft "Hartslag stabiel" in de terminal
// etc.
...
if (monitorColor === "green") {
    console.log("Alles onder controle");
}